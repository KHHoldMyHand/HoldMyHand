                    ...
                    <form id="contactForm" action="<%=request.getContextPath()%>/creditForm" method="POST">
                        <div style="overflow-y:scroll; width: 100%; height: 300px; padding: 10px; margin: auto; border: 1px solid #ababab">
                            <div class="package_wrap w740 help_reset wrap_terms">
                                ...
                                <h4 id="termsCompany003">제3조 (약관의 명시와 개정)</h4>
                                <ol>
                                    <li>
                                ...
                                <h4 id="termsCompany004">제4조 (약관 외 준칙)</h4>
                                <ol>
                                    <li>
                                ...
                                <h4 id="termsCompany005">제5조 (기업회원에 대한 고지, 통지 및 공지)</h4>
                                <ol>
                                    <li>
                                ...
                                <h3>제 2장 회원 가입</h3>
                                <h4 id="termsCompany006">제6조 (서비스 이용계약의 성립)</h4>
                                <ol>
                                    <li>
                                ...
                                <h4 id="termsCompany007">제7조 (회원 가입 신청)</h4>
                                <ol>
                                    <li>
                                ...
                                <h4 id="termsCompany008">제8조 (기업회원 가입 신청의 승낙과 제한)</h4>
                                <ol>
                                ...
                                <h4 id="termsCompany009">제9조 (증빙 자료의 제출)</h4>
                                <ol>
                                    <li>
                                ...
                                <h3>제3장 서비스의 이용</h3>
                                <h4 id="termsCompany010">제10조 (서비스의 내용)</h4>
                                <ol>
                                ...
                                <h4 id="termsCompany011">제11조 (기업정보 및 채용공고의 등록, 이력서 검색)</h4>
                                <ol>
                                    <li>
                                ...
                                <h4 id="termsCompany012">제12조 (제휴를 통한 서비스)</h4>
                                <ol>
                                    <li>
                                ...
                                <h4 id="termsCompany013">제13조 유료 광고·공고상품·제반 유료 서비스 이용요금</h4>
                                <ol>
                                    <li>
                                ...
                                <h4 id="termsCompany014">제14조 (이용요금의 과오납, 과소 청구와 정산)</h4>
                                <ol>
                                ...
                                <h4 id="termsCompany015">제15조 (이용요금의 환불)</h4>
                                <ol>
                                ...
                                <h4 id="termsCompany016">제16조 (S-포인트의 적립 및 이용 등)</h4>
                                <ol>
                                    <li>
                                ...
                                <h4 id="termsCompany017">제17조 (서비스 이용시간 및 제공 중지)</h4>
                                <ol>
                                    <li>
                                    ...
                                    <li>
                                        <ol>③	회사는 다음 각 호에 해당하는 경우 서비스의 제공을 중지할 수 있습니다.
                                            <li>
                                ...
                                <h4 id="termsCompany018">제18조 (서비스 정보의 제공 또는 기타 광고의 게재)</h4>
                                <ol>
                                    <li>
                                ...
                                <h4 id="termsCompany019">제19조 (게시물 작성과 회사의 수정·삭제 권한)</h4>
                                <ol>
                                    <li>
                                ...
                                <h4 id="termsCompany019_2">제19조의 2 (메시지 서비스)</h4>
                                <ol>
                                    <li>
                                ...
                                <h4 id="termsCompany020">제20조 (채용 관련 정보의 제공 및 활용)</h4>
                                <ol>
                                    <li>
                                ...
                                <h4 id="termsCompany021">제21조 (게시물과 지식재산권 등)</h4>
                                <ol>
                                    <li>
                                ...
                                <h4 id="termsCompany022">제22조 (회사의 의무)</h4>
                                <ol>
                                    <li>
                                ...
                                <h4 id="termsCompany023">제23조 (기업회원의 의무)</h4>
                                <ol>
                                    <li>
                                ...
                                <h4 id="termsCompany024">제24조 (서비스 부정이용행위)</h4>
                                <ol>
                                    <li>
                                ...
                                <h4 id="termsCompany025">제25조 (서비스의 부정이용에 대한 제재조치 등)</h4>
                                <ol>
                                    <li>
                                ...
                                <h3>제 5장 기타</h3>
                                <h4 id="termsCompany026">제26조 (손해배상)</h4>
                                <ol>
                                    <li>
                                ...
                                <h4 id="termsCompany027">제27조 (면책)</h4>
                                <ol>
                                    <li>
                                ...
                                <h4 id="termsCompany028">제28조 (서비스 이용계약 해지 및 자동탈퇴)</h4>
                                <ol>
                                    <li>
                                ...
                                <h4 id="termsCompany029">제29조 (분쟁의 해결)</h4>
                                <ol>
                                    <li>
